<?php 
	...
	$page_konten = mysqli_query ($conn, "SELECT page_name, content_name 			  FROM  tb_page_content WHERE content_id  = 4");//id konten halaman tentang//
...
<head>
	...
	<title>Kontomululyo || Portofolio</title>
