<?php 
	...
	$page_konten = mysqli_query ($conn, "SELECT page_name, content_name 			  FROM  tb_page_content WHERE content_id  = 3");//id konten halaman tentang//
...
<head>
	...
	<title>Kontomululyo || Mitra</title>
...
<body>
	...
	<!-- konten -->
		...
		<div class="container">
		<div class="box">
		<center><h1><?php echo $k->page_name ?></h1>
				<br>
				<a href ="https://ud-sadar-jaya.business.site/"><img src="img/sadar.jpg" width="150" height="auto" margin="10px"/></a>
				<a href ="https://ud-rul.business.site/"><img src="img/rul.jpg" width="150" height="auto" margin="10px"/></a>
				<a href ="http://www.alamhijauselaras.com/"><img src="img/alam.png" width="150" height="auto" margin="10px"/></a>
				<br><br></center>
				<center><p><?php echo $k->content_name ?></p></center>
			</div>
		</div>
