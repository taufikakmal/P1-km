...
<head>
	...
	<title>KM-Panel || Admin Profil</title>
...
<a class="active" href="profil.php">Admin Profil</a>
		...
		<div class="container">
			...
			<div class="box">
				<form action="" method="POST">
					...
					<input type="submit" name="submit" value="Ubah Profil" class="btn_edit_data">
				</form>
				<?php 
			...
			<div class="box">
				<form action="" method="POST">
					...
					<input type="submit" name="ubah_password" value="Ubah Password" class="btn_edit_data">
				</form>
				<?php 
